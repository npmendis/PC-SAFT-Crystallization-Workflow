$set matout "'fixedopt_out.gdx', solver_status, infes, objval, T, P, rho_pure, rho, F, x, Q, deviation_sol1"
...
*GAMS model for the fixed-solvent optimization problem of Type 1
