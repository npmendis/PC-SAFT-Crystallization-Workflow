$set matout "'fixedopt_out.gdx', solver_status, infes, objval, rho_pure, rho, F, x, deviation_sol2"
...
*GAMS model for the fixed-solvent optimization problem of Type 22
...
m.fx('3')=pcsaft_para_sol_ini('3','1');
sigma.fx('3')=pcsaft_para_sol_ini('3','2');
epsilon.fx('3')=pcsaft_para_sol_ini('3','3');
bi_eps.fx('3')=pcsaft_para_sol_ini('3','4');
kappa.fx('3')=pcsaft_para_sol_ini('3','5');
...
model deviations /deviation_sol2_define,obj_dev_define/;

solve deviations using nlp maximizing obj_dev;

display pcsaft_para_sol2, deviation_sol2.l;
