...
*GAMS model for the relaxed optimization problem of Type 22
...
Parameters
   ...
   x_solute_in solute inlet mole fraction
...
m.l('3')=pcsaft_para_sol_ini('3','1');
m.lo('3')=1;
m.up('3')=7;

sigma.l('3')=pcsaft_para_sol_ini('3','2');
sigma.lo('3')=1;
sigma.up('3')=7;

epsilon.l('3')=pcsaft_para_sol_ini('3','3');
epsilon.lo('3')=50;
epsilon.up('3')=5000;

bi_eps.l('3')=pcsaft_para_sol_ini('3','4');
bi_eps.lo('3')=500;
bi_eps.up('3')=3500;

kappa.l('3')=pcsaft_para_sol_ini('3','5');
kappa.lo('3')=0.001;
kappa.up('3')=2;
