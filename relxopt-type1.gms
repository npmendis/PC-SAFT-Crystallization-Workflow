...
*GAMS model for the relaxed optimization problem of Type 1
...
rho.l(state)=6/pi*uniform(0.1,0.6)/sum(i,x.l(i,state)*m.l(i)*power(d.l(i,state),3));
rho.lo(state)=0.001;
rho.up(state)=0.035;
...
mass_balance(i)..F('1')*x(i,'1')=e=F('3')*x(i,'3')+F('4')*x(i,'4');
