$set matout "'fixed_out.gdx', solver_status, infes, objval, T, P, rho_pure, rho, F, x, Q, deviation_sol1"
...
*GAMS model for the fixed-solvent optimization problem of Type 3
...
m.fx('2')=pcsaft_para_sol_ini('2','1');
sigma.fx('2')=pcsaft_para_sol_ini('2','2');
epsilon.fx('2')=pcsaft_para_sol_ini('2','3');
bi_eps.fx('2')=pcsaft_para_sol_ini('2','4');
kappa.fx('2')=pcsaft_para_sol_ini('2','5');
...
if (obj_type=3, solve fixedopt using nlp minimizing obj3);
...
model deviations /deviation_sol1_define,obj_dev_define/;

solve deviations using nlp maximizing obj_dev;

display pcsaft_para_sol1, deviation_sol1.l;
